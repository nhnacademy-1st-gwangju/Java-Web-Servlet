...
import com.nhnacademy.board.domain.JsonPostRepository;
import com.nhnacademy.board.domain.JsonUserRepository;
...
//        servletContext.setAttribute("postRepository", new MemoryPostRepository());
        servletContext.setAttribute("postRepository", new JsonPostRepository());
